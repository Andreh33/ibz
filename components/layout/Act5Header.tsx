...
export function Act5Header({
  ...
  return (
    <div
      ref={ref}
      className="absolute inset-x-0 top-[3%] z-10 mx-auto max-w-2xl px-6 text-center"
      style={{ willChange: 'opacity, transform' }}
    >
      <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-ivory/95 drop-shadow-[0_2px_18px_rgba(4,16,29,0.55)]">
        {eyebrow}
      </p>
      <h2 className="mt-3 font-display text-[clamp(28px,3.8vw,52px)] font-light leading-[1.1] tracking-[-0.02em] text-ivory drop-shadow-[0_2px_24px_rgba(4,16,29,0.5)]">
        {headline}
      </h2>
      <p className="mt-3 font-sans text-[14px] leading-[1.6] text-ivory/90 drop-shadow-[0_2px_18px_rgba(4,16,29,0.55)]">
        {intro}
      </p>
    </div>
  );
